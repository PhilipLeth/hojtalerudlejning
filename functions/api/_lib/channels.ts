...
function absUrl(path: string, origin: string): string {
  if (!path) return `${origin}/images/product-party-v2.webp`;
...
export function buildFeedItems(
  ...
  for (const a of addons) {
    ...
    items.push({
      ...
      image: absUrl(String(a.image || "/images/product-party-v2.webp"), origin),
      link: `${origin}/?product=${encodeURIComponent(id)}#book`,
      availability: qty === undefined || qty > 0 ? "in stock" : "out of stock",
      category: "Tilvalg",
      brand: "Lejhøjtaler.dk",
...
const DEFAULT_CATALOG: CatalogRaw = {
  speakers: [
    { id: "thumpgo", price: 345, product: "/images/product-thumpgo-v2.webp", da: { name: "Mackie Thump GO", desc: "Batteridrevet 8\" højtaler med Bluetooth." } },
    { id: "party", price: 395, product: "/images/product-party-v2.webp", da: { name: "Lille højtalerpakke", desc: "2× 10\" Alto — passer i bæretaske." } },
    { id: "soundboks", price: 595, product: "/images/product-soundboks-v2.webp", da: { name: "Soundboks 4", desc: "Batteridrevet Soundboks 4 med kraftig bas." } },
    { id: "festival", price: 695, product: "/images/product-festival-v2.webp", da: { name: "Mellem højtalerpakke", desc: "2× 12\" EV — klar til større events." } },
  ],
  rentalProducts: [
    ...
    { id: "pakke_fest_stor", category: "lyd", price: 895, image: "/images/product-pakke-fest-stor.webp", name_da: "Stor festpakke", desc_da: "Mellem højtalerpakke + lysbar til 100 pers. — spar 95 kr." },
    { id: "discokugle", category: "lys", price: 245, image: "/images/product-discokugle-v2.webp", name_da: "Discokugle", desc_da: "Roterende discokugle med LED." },
    { id: "lyskaeder", category: "lys", price: 195, image: "/images/product-lyskaeder-v2.webp", name_da: "Lyskæde varm hvid", desc_da: "10m lyskæde med varmt hvidt lys." },
    { id: "lyskaeder_farvet", category: "lys", price: 195, image: "/images/product-lyskaeder-farvet-v2.webp", name_da: "Lyskæde farvet", desc_da: "10m lyskæde med farvede pærer." },
    { id: "uplight", category: "lys", price: 125, image: "/images/product-uplight-v2.webp", name_da: "Uplight", desc_da: "Simpel LED uplight på gulv — plug and play." },
    { id: "uplight_4", category: "lys", price: 395, image: "/images/product-uplight-4-v2.webp", name_da: "Uplight 4-pak", desc_da: "4 LED uplights til vægge og hjørner — spar 105 kr." },
    { id: "traadloes_mikrofon_pro", category: "av", price: 495, image: "/images/product-mikrofon-pro-v2.webp", name_da: "Trådløs mikrofon PRO", desc_da: "Shure BLX trådløs mikrofon — scenekvalitet." },
    { id: "haandholdt_mikrofon_pro", category: "av", price: 195, image: "/images/product-mikrofon-kabel-pro-v2.webp", name_da: "Håndholdt mikrofon PRO (kabel)", desc_da: "Shure Beta 58A med kabel." },
    ...
    { id: "traadloes_mikrofon", category: "av", price: 295, image: "/images/product-mikrofon-v2.webp", name_da: "Trådløs mikrofon", desc_da: "Håndholdt trådløs mikrofon." },
    { id: "headset", category: "av", price: 345, image: "/images/product-headset-v2.webp", name_da: "Trådløst headset", desc_da: "Headset-mikrofon." },
    { id: "headset_pro", category: "av", price: 495, image: "/images/product-headset-v2.webp", name_da: "Trådløst headset PRO", desc_da: "Professionelt headset i broadcast-kvalitet." },
    { id: "haandholdt_mikrofon", category: "av", price: 95, image: "/images/product-mikrofon-v2.webp", name_da: "Håndholdt mikrofon (kabel)", desc_da: "Almindelig håndholdt mikrofon med kabel." },
    { id: "laerred_160", category: "av", price: 195, image: "/images/product-laerred-v2.webp", name_da: "Lærred 160 cm", desc_da: "160 cm lærred på stativ." },
    ...
    { id: "pakke_tale_musik", category: "av", price: 895, image: "/images/product-festival-v2.webp", name_da: "Tale & musik-pakken", desc_da: "Mellem højtalerpakke + trådløs mikrofon — spar 95 kr." },
    { id: "karaoke", category: "av", price: 695, image: "/images/product-karaoke-v2.webp", name_da: "Karaokemaskine", desc_da: "Singing Machine m. skærm, 2 trådløse mikrofoner og festlys." },
    { id: "pakke_karaoke", category: "av", price: 1100, image: "/images/product-pakke-karaoke-v2.webp", name_da: "Karaokepakken", desc_da: "Karaokemaskine + 32\" skærm + lille højtalerpakke — spar 385 kr." },
    { id: "pakke_karaoke_fest", category: "av", price: 1500, image: "/images/product-pakke-karaoke-fest-v2.webp", name_da: "Karaoke-festpakken", desc_da: "Karaokemaskine + 55\" storskærm + store højtalere — spar 485 kr." },
    { id: "low_fog", category: "roeg", price: 295, hidden: true, image: "/images/product-lowfog-v2.webp", name_da: "Low fog-maskine", desc_da: "Røggulv med is." },
  ],
  addons: [
    { id: "lyseffekt", price: 195, image: "/images/product-lyseffekt-v2.webp", da: { label: "Enkelt lyseffekt", desc: "1 LED-par-lys med farveeffekter — uden stativ, plug and play." } },
    { id: "lys", price: 495, image: "/images/product-lys-v2.webp", da: { label: "Lysbar", desc: "2 farvede lamper + centereffekt." } },
    { id: "rog", price: 245, image: "/images/product-rog-v2.webp", da: { label: "Røgmaskine", desc: "Kompakt røgmaskine inkl. væske." } },
