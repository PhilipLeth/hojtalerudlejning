...
const DEFAULT_CATALOG: CatalogRaw = {
  speakers: [
    ...
    { id: "festival", price: 695, product: "/images/product-festival-v2.webp", da: { name: "Stor højtalerpakke", desc: "2× 12\" EV — klar til større events." } },
  ],
  rentalProducts: [
    ...
    { id: "pakke_tale_musik", category: "av", price: 895, image: "/images/product-festival-v2.webp", name_da: "Tale & musik-pakken", desc_da: "Stor højtalerpakke + trådløs mikrofon — spar 95 kr." },
  ...
  addons: [
    ...
    { id: "lys", price: 495, image: "/images/product-lys-v2.webp", da: { label: "Lys-pakke", desc: "2 farvede lamper + centereffekt." } },
