...
MOTIVER = {
    ...
    "dj_pult": {"fil": "product-dj-pult-white.png", "prompt": (
        "Webshop product cut-out on a flat seamless pure white background, nothing else in the picture: "
        "a professional all-in-one standalone DJ system, wide matte black unit with a large colour "
