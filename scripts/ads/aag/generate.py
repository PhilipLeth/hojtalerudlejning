...
Kun produkter fra Frederiks produktark (17. sept 2026). Skærme, projektor, lærred,
AV-udstyr og karaoke står ikke i arket og må ikke have aktive annoncer.
...
P = [
 ...
 dict(navn="Trådløs mikrofon", s="trådløs mikrofon", pl="trådløse mikrofoner", url="/traadloes-mikrofon", path="mikrofon", pris="445 kr.", bud=9,
      usp=["Håndholdt Med Modtager", "Shure BLX24 Med SM58", "Til Taler, Sang Og Karaoke"],
      d="Håndholdt med modtager og kabel til højtaler.", d2="Lej trådløs Shure-mikrofon for 445 kr. Passer til vores højtalere og til dit eget anlæg."),
 dict(navn="Håndholdt mikrofon", s="håndholdt mikrofon", url="/haandholdt-mikrofon", path="mikrofon", pris="fra 95 kr.", bud=9, fam="12",
      ...
      d="Håndholdt mikrofon med kabel til taler og sang.", d2="Lej håndholdt mikrofon fra 95 kr. Shure Beta 58A med kabel fra 345 kr."),
 dict(navn="Headset", s="headset mikrofon", url="/headset-mikrofon", path="headset", pris="445 kr.", bud=9, fam="13",
      usp=["Trådløst Headset Til Talere", "Bodypack Og Modtager Med", "Til Konference Og Scene"],
      d="Trådløst headset med bodypack og modtager.", d2="Lej headset mikrofon til præsentationer og konferencer. Shure BLX14 med bodypack."),
 dict(navn="Røgmaskine", s="røgmaskine", pl="røgmaskiner", url="/roegmaskine", path="roegmaskine", pris="fra 245 kr.",
 ...
 dict(navn="Discokugle", s="diskokugle", pl="diskokugler", alt=["discokugle"], url="/discokugle", path="discokugle", pris="fra 545 kr.", bud=9,
 ...
 dict(navn="Diskolys", s="diskolys", art="", alt=["discolys"], url="/diskolys", path="diskolys", pris="fra 495 kr.",
      usp=["Lys Der Kører Til Musikken", "Diskolys-Pakken 685 kr.", "Klar Til Dansegulvet"],
      d="Effekter der kører selv til musikken, klar til fest.", d2="Diskolys-pakken 685 kr: flere effekter, stativ og alle kabler. Plug and play uden teknik."),
 dict(navn="Festlys", s="festlys", art="", url="/festlys", path="festlys", pris="fra 395 kr.",
 ...
 dict(navn="Lysshow", s="lysshow", art="et", url="/lysshow", path="lysshow", pris="fra 1.140 kr.", fam="13",
 ...
 dict(navn="Uplights", s="uplight", pl="uplights", url="/uplights", path="uplights", pris="fra 195 kr.", bud=9, fam="13",
      usp=["LED Uplight, Plug And Play", "4-Pak 595 kr.", "Farvet Lys På Vægge Og Hjørner"],
      d="LED uplights på gulv, plug and play.", d2="Lej uplights enkeltvis eller som 4-pak for 595 kr. Vasker vægge og hjørner i farvet lys."),
 ...
 dict(navn="PA-anlæg", s="pa anlæg", art="et", alt=["pa-anlæg"], url="/lydanlaeg", path="pa-anlaeg", pris="fra 795 kr.",
 ...
 dict(navn="Festudstyr", s="festudstyr", art="", url="/", path="festudlejning", pris="fra 495 kr.", bud=9,
      usp=["Lyd, Lys Og Røg Til Festen", "Alt Klar Til Weekendens Fest", "Højtalere Fra 495 kr."],
...
PS = {p["s"]: p for p in P}  # opslag på produktord, så listen ovenfor kan ændres frit
S = [
 (PS["højtaler"], "lej højtaler til fest", ["lej højtaler til fest", "lej højtalere til fest", "leje af højtaler til fest", "leje af højtalere til fest", "højtaler til fest leje"],
 ...
 (PS["højtaler"], "festhøjtaler leje", ["festhøjtaler leje", "lej festhøjtaler", "lej festhøjtalere", "festhøjtaler udlejning", "leje af festhøjtaler"],
 ...
 (PS["højtaler"], "party højtaler leje", ["party højtaler leje", "lej party højtaler", "lej partyhøjtaler", "partyhøjtaler leje"],
 ...
 (PS["soundboks"], "lån soundboks", ["lån soundboks", "lån en soundboks"], {}),
 (PS["mikrofon"], "leje af mikrofon og højtaler", ["leje af mikrofon og højtaler", "lej mikrofon og højtaler", "mikrofon og højtaler leje"],
  dict(url="/pakke-tale-musik", path="tale-musik", pris="1.145 kr.", navn="Speakerpakke trådløs 30-50", usp=['2× 12" Højtalere + Trådløs Mic', "Til Taler Og Musik", "Alle Kabler Med"], d='2× 12" højtalere og trådløs mikrofon i én pakke.', d2="Leje af mikrofon og højtaler som pakke: taler og musik til events, alle kabler med.")),
 (PS["lyskæde"], "lej lyskæder til fest", ["lej lyskæder til fest", "lyskæder til fest leje", "leje af lyskæder til fest"], {}),
 (PS["lyskæde"], "lej lyskæder til bryllup", ["lej lyskæder til bryllup", "lyskæder til bryllup leje", "leje af lyskæder til bryllup"], {}),
 (PS["festlys"], "lys til fest", ["lej lys til fest", "lys til fest leje", "leje lys til fest", "leje af lys til fest", "udlejning af lys til fest"], {}),
 (PS["festlys"], "lyd og lys udlejning", ["lyd og lys udlejning", "lys og lyd udlejning", "udlejning af lyd og lys"],
  dict(url="/festpakke-lille", path="lyd-og-lys", pris="fra 895 kr.", navn="Festpakke 0-30", usp=["Højtalere + Lysbar I Én Pakke", "Festpakke 0-30 For 895 kr.", "Klar Til Dansegulvet"], d="Højtalere og festlys i én pakke med alle kabler.", d2="Lyd og lys udlejning som pakke: 2 højtalere med Bluetooth, diskolys og stativ.")),
 (PS["festlys"], "lej lyd og lys", ["lej lyd og lys", "lej lys og lyd", "leje af lyd og lys", "leje af lys og lyd", "lej lyd og lys til fest"],
  dict(url="/festpakke-lille", path="lyd-og-lys", pris="fra 895 kr.", navn="Festpakke 0-30", usp=["Højtalere + Lysbar I Én Pakke", "Festpakke 0-30 For 895 kr.", "Klar Til Dansegulvet"], d="Højtalere og festlys i én pakke med alle kabler.", d2="Lej lyd og lys som pakke: 2 højtalere med Bluetooth, diskolys og stativ.")),
 (PS["lydanlæg"], "lydudlejning", ["lydudlejning", "lydudlejning københavn", "lyd udlejning", "lyd udlejning københavn"],
 ...
 (PS["musikanlæg"], "musikanlæg til fest", ["leje af musikanlæg til fest", "lej musikanlæg til fest", "musikanlæg til fest leje"], {}),
 (PS["anlæg"], "anlæg til fest", ["lej anlæg til fest", "leje af anlæg til fest", "anlæg til fest leje", "lydanlæg til fest leje"], {}),
 (PS["festudstyr"], "festudlejning", ["festudlejning", "festudlejning københavn", "fest udlejning"], dict(navn="Festudlejning")),
 (PS["festudstyr"], "lej til fest", ["lej til fest", "leje til fest", "lej udstyr til fest", "udstyr til fest leje"], dict(navn="Festudlejning")),
]
