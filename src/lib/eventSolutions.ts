...
export const eventSolutions = [
  ...
  {
    id: "reception", image: "reception-front", productIds: ["festival", "stativer", "traadloes_mikrofon_pro", "mixer_stor", "uplight_4"],
  ...
  {
    id: "koncert", image: "concert", productIds: ["festival", "stativer", "subwoofer", "mixer_stor", "haandholdt_mikrofon", "uplight_4"],
