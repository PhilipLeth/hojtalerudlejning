...
export const t = {
  da: {
    ...
    booking: {
      ...
      afterHoursPickup: "Afhentning uden for åbningstid",
      afterHoursReturn: "Aflevering uden for åbningstid",
      ...
      payAtPickupNote: "Betales ved afhentning — MobilePay eller kontant",
  ...
  en: {
    ...
    booking: {
      ...
      afterHoursPickup: "Pickup outside opening hours",
      afterHoursReturn: "Return outside opening hours",
      ...
      payAtPickupNote: "Payable on pickup — MobilePay or cash",
