...
export const t = {
    ...
    booking: {
      ...
      addons: [
        ...
        },
        {
          id: "rog",
          label: "Røgmaskine",
          desc: "Kompakt røgmaskine inkl. røgvæske — gør lyset 10x federe",
        },
        {
          id: "stativer",
          label: "Højtalerstativer",
          desc: "2 professionelle stativer — løfter lyden op i øjenhøjde",
        },
        {
          id: "taske",
          label: "Bæretaske",
          desc: "Polstret sportstaske til sikker transport på cykel eller i bil",
        },
        {
          id: "levering",
          label: "Levering + opsætning",
          desc: "Vi bringer, sætter op og henter i Storkøbenhavn",
        },
      ],
  ...
  en: {
    ...
    booking: {
      ...
      addons: [
        {
          id: "lys",
          label: "Light package",
          desc: "2 coloured lamps + centre effect on stand",
        },
        {
          id: "rog",
          label: "Fog machine",
          desc: "Compact fog machine incl. fluid — makes the lights 10x better",
        },
        {
          id: "stativer",
          label: "Speaker stands",
          desc: "2 professional stands — lifts the sound to ear level",
        },
        {
          id: "taske",
          label: "Carry bag",
          desc: "Padded sports bag for safe transport by bike or car",
        },
        {
          id: "levering",
          label: "Delivery + setup",
          desc: "We deliver, set up and collect in greater Copenhagen",
        },
      ],
      ...
      lightsOnlyFrom: "From 500,-",
      fogOnlyFrom: "From 250,-",
      pickup: "Pickup",
      returnLabel: "Return",
