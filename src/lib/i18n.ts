...
export const t = {
  da: {
    ...
    hero: {
      ...
      cta: "Book nu",
      phone: "Ring 31 13 28 52",
      mobilePay: "Betal ved afhentning",
      urgencySoldOut: "Anlæggene er udsolgt denne weekend — tjek næste weekend",
      urgencyFew: "Kun {n} anlæg ledige til denne weekend",
      urgencyAvailable: "Anlæg ledige til denne weekend",
  ...
  en: {
    ...
    hero: {
      ...
      cta: "Book now",
      phone: "Call 31 13 28 52",
      mobilePay: "Pay at pickup",
      urgencySoldOut: "Speaker systems are sold out this weekend — check next weekend",
      urgencyFew: "Only {n} systems left for this weekend",
      urgencyAvailable: "Systems available for this weekend",
