...
export const t = {
  da: {
    ...
    booking: {
      ...
      deliveryIncludedLabel: "Levering, opsætning og afhentning er med",
      deliveryIncludedDesc: "Lydmanden kommer med grejet, sætter op og tager det med hjem igen",
      deliveryIncluded: "Inkl.",
      ...
      whenPickup: "Hvornår henter du?",
      whenReturn: "Hvornår afleverer du?",
      timeWeCall: "Vi ringer og aftaler tidspunktet med dig.",
      timeDelivered: "Vi kører ud til dig, tidspunktet aftaler vi over telefonen.",
      perHour: "pr. time",
      lydmandHours: "Antal timer",
      lydmandHour: "time",
      lydmandHoursWord: "timer",
      lydmandFrom: "Fra kl.",
      lydmandTo: "Til kl.",
      lydmandTimesHint: "Valgfrit, så ved lydmanden, hvornår festen starter. Timerne regnes ud af tiderne.",
      stroemTitle: "Mangler I strøm?",
      stroemHint: "Står anlægget langt fra en stikkontakt, eller skal højtaler, lys og røg dele ét udtag?",
      stroemOpen: "Se forlængerledninger og stikdåser",
      ...
      lightsSoldOutPeriod: "Lysbaren er desværre udsolgt i denne periode",
      ...
      calendarNote: "Samme pris i 1-5 dage. Hent fredag, aflever mandag.",
      ...
      // Success page
      haveDiscountCode: "Har du en rabatkode?",
      printReceipt: "Print kvittering",
      newBooking: "Lej noget mere",
      notFinalTitle: "Dette er ikke din endelige ordrebekræftelse.",
      notFinalBody: "En medarbejder gennemgår bestillingen, og du får den endelige bekræftelse på mail. Sig endelig til, hvis noget skal ændres inden da.",
      paidOnlineNote: "Betalt online",
      payAtPickupNote: "Betales ved afhentning, MobilePay",
    ...
    googleReviews: {
      ...
      badge: "Anmeldelser på Google",
      outOf: "ud af 5",
      seeAll: "Se alle på Google",
  ...
  en: {
    ...
    booking: {
      ...
      deliveryIncludedLabel: "Delivery, setup and collection included",
      deliveryIncludedDesc: "The sound engineer arrives with the gear, sets up and takes it home again",
      deliveryIncluded: "Incl.",
      ...
      whenReturn: "When will you return it?",
      timeWeCall: "We will call you to agree on a time.",
      timeDelivered: "We drive to you, we agree on the time by phone.",
      perHour: "per hour",
      lydmandHours: "Hours",
      lydmandHour: "hour",
      lydmandHoursWord: "hours",
      lydmandFrom: "From",
      lydmandTo: "To",
      lydmandTimesHint: "Optional, so the engineer knows when the party starts. Hours are calculated from the times.",
      stroemTitle: "Do you need power?",
      stroemHint: "Is the system far from a socket, or do speaker, lights and fog have to share one outlet?",
      stroemOpen: "See extension leads and power strips",
      ...
      lightsSoldOutPeriod: "The light bar is unfortunately sold out for this period",
      ...
      calendarNote: "Same price for 1-5 days. Collect Friday, return Monday.",
      ...
      newBooking: "Rent something else",
      notFinalTitle: "This is not your final order confirmation.",
      notFinalBody: "One of us will go through the booking, and you'll get the final confirmation by email. Just tell us if anything needs changing before then.",
      paidOnlineNote: "Paid online",
      payAtPickupNote: "Payable on pickup, MobilePay",
    ...
    googleReviews: {
      ...
      subtitle: "Real reviews, pulled straight from our Google profile.",
    ...
    footer: {
      ...
      aboutHref: "/en/om",
      blogHref: "/en/blog",
      pricesHref: "/en/priser",
      deliveryHref: "/en/levering",
