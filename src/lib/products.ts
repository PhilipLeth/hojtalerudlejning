...
export const rentalProducts: RentalProduct[] = [
  ...
  // Levering/opsætning er bevidst IKKE med i pakken — det kan tilvælges i booking.
  {
    ...
    desc_da: "Lille højtalerpakke + lys-pakke. Lyd og lys til op til 40 pers. — spar 100 kr.",
    desc_en: "Small speaker package + light package. Sound and lights for up to 40 people — save 100 DKK.",
    contents: ['2× Alto 10" højtalere', "Lys-pakke (2 lamper + centereffekt)", "Bluetooth + alle kabler", "Bæretaske"],
    allowedAddons: ["rog", "stativer", "mikrofon", "levering", "levering_opsaetning"],
    bundle: {
      discount: 100,
  ...
  },
  {
    ...
    desc_da: "Stor højtalerpakke + lys-pakke. Lyd og lys til op til 100 pers. — spar 100 kr.",
    desc_en: "Large speaker package + light package. Sound and lights for up to 100 people — save 100 DKK.",
    contents: ['2× EV 12" højtalere', "2× stativer", "Lys-pakke (2 lamper + centereffekt)", "Bluetooth + alle kabler"],
    allowedAddons: ["rog", "mikrofon", "levering", "levering_opsaetning"],
    bundle: {
      discount: 100,
  ...
  { id: "projektor_pro", category: "av", price: 795, image: "/images/product-projektor-pro.png", name_da: "Projektor Pro (5000 lumen)", name_en: "Projector Pro (5000 lumen)", desc_da: "Kraftig 5000 lumen projektor — skarp selv i dagslys.", desc_en: "Powerful 5000 lumen projector — sharp even in daylight.", contents: ["5000 lumen projektor", "HDMI-kabel", "Strømkabel", "Fjernbetjening"] },
