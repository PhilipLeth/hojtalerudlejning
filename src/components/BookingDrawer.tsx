...
/** True when URL asks for booking drawer (?product= and/or #book) */
...
/**
 * Booking i en drawer: åbner ved #book og /?product=ID#book.
 * Lytter også til Next.js soft-nav (pushState) — ellers åbner den ikke
 * når man klikker Book mens man allerede er på forsiden.
 */
