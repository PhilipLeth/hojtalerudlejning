 ...
 * altid linker til forsiden + tydeligt telefonnummer. Ligger i normal flow
 * under den fixed TopBar (spacer via pt).
 */
    ...
    <header className="relative z-30 pt-9">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
        ...
        >
          ...
          <span className="hidden sm:inline">{isEn ? "Call" : "Ring"}</span> {PHONE_DISPLAY}
        </a>
      </div>
    </header>
  );
