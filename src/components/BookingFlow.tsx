...
export default function BookingFlow() {
  ...
  return (
    <section id="book" className="mx-auto max-w-lg px-4 py-24">
      {/* Progress */}
          ...
          <div className="mt-6 space-y-4">
            {speakers.map((s) => (
              <button
                ...
                className={`w-full rounded-2xl p-6 text-left transition active:scale-[0.98] ${
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold text-brand-400">{s.price},-</p>
                    <p className="text-xs text-white/40">pr. weekend</p>
                  </div>
                </div>
              </button>
            ))}
