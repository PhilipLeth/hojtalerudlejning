...
export default function Footer({ locale = "da" }: { locale?: Locale }) {
  ...
  return (
    <footer className="relative z-20 border-t border-white/5 bg-[#07060b] px-4 py-12 text-center text-sm text-white/30">
      ...
      <p className="mt-3">
        <a href="tel:+4550150731" className="inline-flex items-center gap-1.5 font-semibold text-brand-400 hover:text-brand-300 transition">
          ...
          {locale === "da" ? "Ring" : "Call"} 50 15 07 31
        </a>
      </p>
