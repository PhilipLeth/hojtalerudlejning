    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <figure className={styles.heroImage}>
          <img src="/images/product-dj-flx4-white.webp" alt={en ? "DDJ-FLX4 controller with iPad in a flight case" : "DDJ-FLX4 med iPad i flightcase"} width="1024" height="1024" style={{ objectFit: "contain", background: "white" }} />
