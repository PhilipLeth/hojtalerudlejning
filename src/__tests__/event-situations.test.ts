...
describe("DJ-priser",()=>{
 it("beregner dag, nat og blandede timer inklusive moms og levering",()=>{expect(priceDj({before23:3,after23:0}).total).toBe(3795);expect(priceDj({before23:0,after23:3}).total).toBe(5295);expect(priceDj({before23:2,after23:2}).total).toBe(5795);});
