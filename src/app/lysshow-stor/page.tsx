...
export default function Page() {
  return (
    <ProductLanding
      ...
      bullets={[
        "Lysbar: 2 farvede LED-lamper + centereffekt til dansegulvet",
      ...
      <section className="mx-auto max-w-3xl px-4 pb-16">
        <div className="glass rounded-2xl p-8">
          ...
          <p className="mb-6 text-white/50">
            Det store lysshow passer til de Mellem højtalerpakker. Vælg anlæg efter antal gæster, eller tag en festpakke hvor lyd og lys allerede er sat sammen.
          </p>
