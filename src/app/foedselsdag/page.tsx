...
export const metadata: Metadata = {
  title: "Lyd til fødselsdag København | Fra 495 kr | Lejhøjtaler.dk",
  description: "Lej lyd til fødselsdagen i København fra 495 kr. Højtalere til tale og fest, lys og karaoke — til både børnefødselsdag og de runde dage. Book online.",
