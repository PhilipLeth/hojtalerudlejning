...
export default function Page() {
  return (
    <OccasionLanding
      ...
      gridItems={[{"id": "pakke_fest_stor", "tag": "Anbefalet"}, {"id": "pakke_fest_lille"}, {"id": "mikrofon"}, {"id": "discokugle"}, {"id": "pakke_fest_150", "tag": "100-150 gæster"}]}
