...
export const metadata: Metadata = {
  ...
  description:
    "Lej AV-udstyr i København: 55\" storskærm, projektor, lærred, lys, mikrofoner og højtalere. Book online, også til møde, konference og præsentation.",
    ...
    <main className="bg-white text-slate-900">
      <section className="mx-auto max-w-6xl px-5 py-16">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-600">
          Til mødet, konferencen og festen: billedet, lyden og lyset kan lejes hver for sig eller som en færdig
          pakke. Alle priser gælder op til fem dages leje og er inklusive moms.
        </p>
      ...
      <BundleGrid
        ...
        subtitle="Projektor, skærm, mikrofon og lyd sat sammen på forhånd — og billigere end at leje delene hver for sig."
      />
