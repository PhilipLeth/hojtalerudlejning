...
export default function Page() {
  return (
    <OccasionLanding
      ...
      primaryProductId="pakke_soundboks_lille"
      primaryName={"Lille soundboks pakke"}
      primaryWhy={"Polterabenden flytter sig, fra baggården til parken til stranden. Mackie Thump GO kører på batteri og kan bæres med én hånd, og lysbaren tager over, når det bliver mørkt."}
      gridItems={[{"id": "pakke_udendors", "tag": "Anbefalet"}, {"id": "thumpgo"}, {"id": "soundboks"}, {"id": "mikrofon"}, {"id": "rog"}]}
      ...
      related={[{"href": "/soundboks-4", "label": "Soundboks 4, på batteri", "priceId": "soundboks"}, {"href": "/soundboks-4", "label": "Lej en Soundboks"}, {"href": "/studenterkoersel", "label": "Højtaler til studenterkørsel"}, {"href": "/havefest", "label": "Lyd til havefest"}]}
    />
  );
}
