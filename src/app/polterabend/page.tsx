...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/udendorspakke", "label": "Udendørspakken", "priceId": "pakke_udendors"}, {"href": "/soundboks-4", "label": "Lej en Soundboks"}, {"href": "/studenterkoersel", "label": "Højtaler til studenterkørsel"}, {"href": "/havefest", "label": "Lyd til havefest"}]}
    />
  );
}
