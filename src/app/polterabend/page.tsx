...
export default function Page() {
  return (
    <OccasionLanding
      ...
      primaryProductId="thumpgo"
      primaryName={"Mackie Thump GO"}
      primaryPrice={345}
      primaryWhy={"10 kg, op til 12 timers batteri og Bluetooth. Den kan bæres i hånden hele dagen og spiller stadig, når I ender i baggården om aftenen. Skal der være mere tryk på, tager I Soundboks 4 i stedet."}
      gridItems={[{"id": "thumpgo", "tag": "Anbefalet"}, {"id": "soundboks"}, {"id": "traadloes_mikrofon"}, {"id": "rog"}]}
      ...
      related={[{"href": "/soundboks-4", "label": "Soundboks 4"}, {"href": "/studenterkoersel", "label": "Højtaler til studenterkørsel"}, {"href": "/havefest", "label": "Lyd til havefest"}]}
    />
  );
}
