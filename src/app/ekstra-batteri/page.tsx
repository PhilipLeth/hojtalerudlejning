...
export default function Page() {
  return (
    <ProductLanding
      ...
      bullets={[
        "Originalt Soundboks-batteri, passer til Soundboks 4",
      ...
      <section className="mx-auto max-w-3xl px-4 pb-16">
        <div className="glass rounded-2xl p-8">
          ...
          <p className="mb-6 text-white/50">
            Ved almindelig festlydstyrke holder Soundboks 4 omkring 40 timer på lav og 10-12 timer på høj. Skal der spilles højt fra eftermiddag til nat, er det ekstra batteri det, der redder aftenen.
          </p>
