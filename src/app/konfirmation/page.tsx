...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/festpakke-stor", "label": "Stor festpakke", "priceId": "pakke_fest_stor"}, {"href": "/foedselsdag", "label": "Lyd til fødselsdag"}, {"href": "/havefest", "label": "Lyd til havefest"}, {"href": "/traadloes-mikrofon", "label": "Trådløs mikrofon"}]}
    />
  );
}
