...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/festpakke-150", "label": "Festpakke 150 – 2.345 kr"}, {"href": "/festpakke-stor", "label": "Stor festpakke"}, {"href": "/festlys", "label": "Festlys"}, {"href": "/julefrokost", "label": "Lyd til julefrokost"}]}
    />
  );
}
