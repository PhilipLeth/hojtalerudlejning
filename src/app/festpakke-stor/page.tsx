...
export const metadata: Metadata = {
  ...
  description:
    "Stor festpakke: 2× EV 12\" højtalere med stativer + lys-pakke for 895 kr — spar 95 kr. Lyd og lys til op til 100 personer. Levering og opsætning kan tilvælges. Book online.",
...
export default function FestpakkeStorPage() {
  return (
    <ProductLanding
      ...
      sub="2× EV 12&quot; højtalere + stativer + lys-pakke. Fuld fest — spar 95 kr."
