...
export const metadata: Metadata = {
  title: "Lyd til havefest København | Fra 500 kr | Lejhøjtaler.dk",
  description: "Lej lyd til havefesten i København fra 500 kr. Højtalere til udendørs brug, lyskæder og batteriløsninger uden strøm. Book online — betal ved afhentning.",
...
export default function Page() {
  return (
    <OccasionLanding
      ...
      primaryPrice={500}
      primaryWhy={"To Alto-højtalere og en lyseffekt. Udendørs forsvinder lyden hurtigere end indendørs, så to højtalere placeret ved siden af hinanden slår altid én stor — og det giver jævn lyd i hele haven i stedet for ét højt hjørne."}
      gridItems={[{"id": "pakke_fest_lille", "tag": "Anbefalet"}, {"id": "thumpgo"}, {"id": "lyskaeder"}, {"id": "lyskaeder_farvet"}]}
      ...
      related={[{"href": "/foedselsdag", "label": "Lyd til fødselsdag"}, {"href": "/blog/lyd-til-havefest", "label": "Guide: lyd til havefest"}, {"href": "/lyskaeder", "label": "Lyskæder"}]}
    />
  );
}
