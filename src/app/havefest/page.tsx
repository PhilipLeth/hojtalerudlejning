...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/udendorspakke", "label": "Udendørspakken", "priceId": "pakke_udendors"}, {"href": "/foedselsdag", "label": "Lyd til fødselsdag"}, {"href": "/blog/lyd-til-havefest", "label": "Guide: lyd til havefest"}, {"href": "/lyskaeder", "label": "Lyskæder"}]}
    />
  );
}
