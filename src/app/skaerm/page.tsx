...
export const metadata: Metadata = {
  title: "Lej Storskærm København | Fra 600 kr | Lejhøjtaler.dk",
  description:
    "Lej 55\" LED-storskærm i København fra 600 kr/weekend. Skærm på gulvstativ til præsentationer og events. Fungerer i dagslys. Ingen depositum.",
  keywords: [
    "lej storskærm",
    "skærm udlejning",
    "skærm til event",
  ...
  openGraph: {
    title: "Lej Storskærm København | Fra 600 kr",
    description:
      "Lej 55\" LED-storskærm i København fra 600 kr/weekend. Gulvstativ inkluderet. Book online.",
      ...
      <main className="relative z-20 bg-[#07060b]">
          ...
          <div className="grid gap-8 sm:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="mb-6 text-3xl font-bold text-brand-400">
                600 kr<span className="text-lg font-normal text-white/40">/weekend</span>
              </p>
        ...
        <section className="mx-auto max-w-2xl px-4 pb-24 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-white/50">
            Book online på 2 minutter. Hent fredag i København K, aflever mandag. Kun 600 kr/weekend.
          </p>
          <a
            href="/#book"
            className="mt-8 inline-block rounded-full bg-brand-500 px-8 py-4 text-lg font-semibold text-black transition hover:bg-brand-400 active:scale-95"
