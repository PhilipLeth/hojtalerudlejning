...
export const metadata: Metadata = {
 ...
 openGraph: { title: "AV og eventteknik til erhverv i København", description: "Lyd, skærme, projektorer, mikrofoner og lys til møder, messer, receptioner og mindre koncerter. Levering, opsætning og tekniker efter aftale.", url: "https://lejhojtaler.dk/erhverv", images: ["/images/events/reception-detail.webp"], locale: "da_DK" },
};
