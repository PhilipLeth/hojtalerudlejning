...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/bryllupspakke", "label": "Bryllupspakken", "priceId": "pakke_bryllup"}, {"href": "/festpakke-stor", "label": "Festpakke 30-50"}, {"href": "/traadloes-mikrofon-pro", "label": "Trådløs mikrofon PRO"}, {"href": "/roeg", "label": "Low fog til første dans"}]}
    />
  );
}
