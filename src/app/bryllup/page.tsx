...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/bryllupspakke", "label": "Bryllupspakken – 2.695 kr"}, {"href": "/festpakke-stor", "label": "Stor festpakke"}, {"href": "/traadloes-mikrofon-pro", "label": "Trådløs mikrofon PRO"}, {"href": "/roeg", "label": "Low fog til første dans"}]}
    />
  );
}
