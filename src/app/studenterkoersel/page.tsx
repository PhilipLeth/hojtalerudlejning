...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/studenterpakke", "label": "Studenterpakken – 745 kr"}, {"href": "/soundboks-4", "label": "Soundboks 4"}, {"href": "/polterabend", "label": "Højtaler til polterabend"}, {"href": "/lej-hojtaler", "label": "Alle højtalere"}]}
    />
  );
}
