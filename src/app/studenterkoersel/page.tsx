...
export default function Page() {
  return (
    <OccasionLanding
      ...
      faq={[{"q": "Holder batteriet en hel dags kørsel?", "a": "Ja. Soundboks 4 spiller op til 40 timer ved normal lydstyrke — ved fuld udblæsning nærmere 5-8 timer, hvilket rækker til en typisk rutedag. Ekstra batteri kan tilkøbes."}, {"q": "Kan den tåle at stå på en lastbil?", "a": "Soundboksen er bygget til udendørs brug og tåler vibrationer og støv. Den skal bare spændes forsvarligt fast og holdes fri af direkte regn."}, {"q": "Hvad koster det for en hel uge?", "a": "Vi tager samme pris for 1 til 5 dage. Skal I bruge den længere, så ring på 31 13 28 52, så finder vi en pris."}, {"q": "Hvem hæfter, hvis den bliver ødelagt?", "a": "Lejer hæfter for skader ud over almindeligt slid — se lejevilkårene. Derfor: spænd den fast, og lad den ikke stå uden opsyn."}]}
