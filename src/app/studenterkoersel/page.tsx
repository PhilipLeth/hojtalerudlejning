...
export default function Page() {
  return (
    <OccasionLanding
      ...
      related={[{"href": "/studenterpakke", "label": "Studenterpakken", "priceId": "pakke_student"}, {"href": "/soundboks-4", "label": "Lej en Soundboks"}, {"href": "/polterabend", "label": "Højtaler til polterabend"}, {"href": "/lej-hojtaler", "label": "Alle højtalere"}]}
    />
  );
}
