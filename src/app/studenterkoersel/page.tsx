...
export default function Page() {
  return (
    <OccasionLanding
      ...
      primaryWhy={"Der er ingen strøm på ladet. Soundboks 4 kører på batteri hele dagen og spiller højt nok til at overdøve vinden på motorvejen. Et ekstra batteri til de lange ruter lægges på i bookingen."}
      gridItems={[{"id": "pakke_student", "tag": "Anbefalet"}, {"id": "soundboks"}, {"id": "thumpgo"}, {"id": "batteri"}, {"id": "mikrofon"}]}
      ...
      related={[{"href": "/soundboks-4", "label": "Soundboks 4", "priceId": "soundboks"}, {"href": "/soundboks-4", "label": "Lej en Soundboks"}, {"href": "/ungdomsfest", "label": "Lyd og lys til studenterfesten"}, {"href": "/polterabend", "label": "Højtaler til polterabend"}, {"href": "/lej-hojtaler", "label": "Alle højtalere"}]}
    />
  );
}
