...
export const metadata: Metadata = {
  title: "Party Package 250 Copenhagen | 2.295 DKK | Lejhøjtaler.dk",
  description:
    'Rent sound and lights for up to 250 guests in Copenhagen for 2.295 DKK. Four 12" speakers, two subwoofers, stands, light package and fog machine. Delivery available.',
  keywords: [
