...
export const metadata: Metadata = {
  ...
  description:
    'Rent sound and lights for your party in Copenhagen from 890 DKK. Two 10" speakers with Bluetooth plus a LED light effect, for up to 40 guests. Save 95 DKK on the bundle.',
  keywords: [
