...
export const metadata: Metadata = {
  title: `Party Package 30-50 Copenhagen | ${prisDkk("pakke_fest_stor")} | 30-50 Guests | Lejhøjtaler.dk`,
  description:
    `Rent sound and lights for 30-50 guests in Copenhagen from ${prisDkk("pakke_fest_stor")}. Two 12" EV speakers plus coloured lights and a centre effect. Save ${rabatDkk("pakke_fest_stor")} on the bundle.`,
  keywords: [
  ...
  return (
    <ProductLanding
      ...
      bullets={[
        ...
        `Speaker stands available as an add-on (${rabatDkk("pakke_fest_stor")})`,
        "Light bar: 2 coloured lamps + centre effect",
        `Save ${rabatDkk("pakke_fest_stor")} compared to renting the parts separately`,
