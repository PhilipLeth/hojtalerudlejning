...
export const metadata: Metadata = {
  ...
  description:
    'Rent sound and lights for up to 100 guests in Copenhagen from 1.290 DKK. Two 12" EV speakers plus coloured lights and a centre effect. Save 200 DKK on the bundle.',
  keywords: [
  ...
  return (
    <ProductLanding
      ...
      bullets={[
        ...
        "Save 200 DKK compared to renting the parts separately",
