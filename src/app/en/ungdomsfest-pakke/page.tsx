      ...
      <section className="mx-auto max-w-3xl px-4 pb-16">
        <div className="glass rounded-2xl p-8">
          ...
          <p className="mb-6 text-white/50">
            Then it is the large youth party package: two 12&quot; speakers, a light bar on a stand, a 40 cm mirror ball and a fog machine, a proper disco for a hall or a barn.
          </p>
