...
export default function Page() {
  return (
    <OccasionLanding
      ...
      faq={[
        { q: "What does sound and lighting for a youth party cost?", a: "The youth party package with Soundboks, light effect and mirror ball is " + prisDkk("pakke_ungdomsfest") + " for up to 5 days of rental. The large package with two 12\" speakers, light bar, mirror ball and fog is " + prisDkk("pakke_ungdomsfest_stor") + ". Both are cheaper than the parts separately." },
        { q: "Do you have UV light, strobes or lasers?", a: "Not yet. We rent mirror balls, LED light effects, a light bar on a stand, uplights and a fog machine, that is what is in the packages, and that is what we can deliver. If you want UV, strobe or laser for the party, write to us: with enough requests we will buy it in." },
