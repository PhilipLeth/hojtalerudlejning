...
export const metadata: Metadata = {
 ...
 openGraph: { title: "Discreet event AV, a setup example", description: "Photos of actual setups. See the gear, then book the package online.", url: "https://lejhojtaler.dk/en/cases", images: ["/images/events/reception-front-v2.webp"], locale: "en_GB" },
};
