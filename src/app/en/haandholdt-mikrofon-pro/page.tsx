...
export const metadata: Metadata = {
  title: `Shure Beta 58A Rental Copenhagen | ${prisDkk("haandholdt_mikrofon_pro")} | Lejhøjtaler.dk`,
  description:
    `Rent a Shure Beta 58A wired microphone in Copenhagen for ${prisDkk("haandholdt_mikrofon_pro")} per weekend. The industry standard for vocals and speeches. XLR cable included. Pay on pickup.`,
  keywords: [
  ...
  openGraph: {
    ...
    title: `Shure Beta 58A Rental Copenhagen | ${prisDkk("haandholdt_mikrofon_pro")}`,
    description:
