...
export const metadata: Metadata = {
 ...
 openGraph: { title: "Lej festudstyr i København | Lyd og lys udlejning", description: "Udlejning af festudstyr: lyd, lys, røg, mikrofon og skærm. Se prisen med det samme og book online.", url: "https://lejhojtaler.dk", images: ["/images/events/reception-detail.webp"], locale: "da_DK" },
};
