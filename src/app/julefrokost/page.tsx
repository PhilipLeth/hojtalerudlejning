...
export default function Page() {
  return (
    <OccasionLanding
      ...
      gridItems={[{"id": "pakke_firmafest", "tag": "Anbefalet"}, {"id": "pakke_karaoke", "tag": "Spar 385,-"}, {"id": "pakke_karaoke_fest", "tag": "Spar 485,-"}, {"id": "karaoke"}, {"id": "lyseffekt"}]}
      ...
      faq={[{"q": "Hvad er forskellen på de to karaokepakker?", "a": "Karaokepakken til 1.300 kr har 32\" skærm og små højtalere og passer til op til 40 personer. Karaoke-festpakken til 2.000 kr har 55\" skærm og store højtalere og klarer op til 100 personer."}, {"q": "Skal vi bruge internet til karaoke?", "a": "Ja, hvis I vil bruge YouTube-karaoke via skærmen. Maskinen har også indbyggede sange og Bluetooth, så I kan streame fra en telefon."}, {"q": "Kan vi leje det til firmaets adresse?", "a": "Ja. Levering og opsætning i København koster 495 kr, og 795 kr hvis vi også henter igen efter frokosten — også hvis det bliver sent."}, {"q": "Hvor mange mikrofoner er der med?", "a": "To trådløse mikrofoner følger med karaokemaskinen, så I kan synge duet uden at sende den samme mikrofon rundt."}]}
      related={[{"href": "/firmafestpakke", "label": "Firmafestpakken – 1.795 kr"}, {"href": "/karaoke", "label": "Alt om karaoke"}, {"href": "/nytaar", "label": "Lyd til nytårsfest"}, {"href": "/erhverv", "label": "Udlejning til erhverv"}]}
    />
  );
}
