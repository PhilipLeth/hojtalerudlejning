...
export const metadata: Metadata = {
 ...
 openGraph: { title: "Diskret AV-opstilling, se vores eksempel", description: "Fotos af konkrete opstillinger. Se grejet, og book pakken online.", url: "https://lejhojtaler.dk/cases", images: ["/images/events/reception-front.webp"], locale: "da_DK" },
};
